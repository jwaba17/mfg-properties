...
Service({
  "submitQuote": Func(
    [QuoteRequest],
    [Record({ "ok": Bool, "error": Opt(Text) })],
    []
  )
});
const idlFactory = ({ IDL: IDL2 }) => {
  const QuoteRequest2 = IDL2.Record({
    "name": IDL2.Text,
    "role": IDL2.Text,
    "email": IDL2.Text,
    "message": IDL2.Text,
  ...
  return IDL2.Service({
    "submitQuote": IDL2.Func(
      [QuoteRequest2],
      [IDL2.Record({ "ok": IDL2.Bool, "error": IDL2.Opt(IDL2.Text) })],
      []
    )
  });
};
...
function Home() {
  ...
  const [agreedToPrivacy, setAgreedToPrivacy] = reactExports.useState(false);
  const [marketingOptIn, setMarketingOptIn] = reactExports.useState(false);
  const [smsOptIn, setSmsOptIn] = reactExports.useState(false);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              onClick: () => {
                var _a2;
                return (_a2 = document.getElementById("pricing")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
              },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-background/60 via-background/20 to-transparent" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-background/40 to-transparent" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "why-choose-mfg", className: "bg-background py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-background/30 via-transparent to-primary/50" })
        ]
      }
    ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-primary/40 via-transparent to-transparent" }),
        ...
        "form",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground font-body", children: "Consent & Preferences" }) }),
              [
                {
                  id: "privacy",
                  ...
                  helper: "Explains how your data is collected, stored, and used.",
                  badge: "Required",
                  badgeVariant: "required",
                  checked: agreedToPrivacy,
                  onChange: (v) => setAgreedToPrivacy(v),
                  ocid: "pricing.privacy_checkbox"
                },
                {
                  id: "marketing",
                  label: "I would like to receive updates, promotions, and community news via email.",
                ...
                {
                  id: "sms",
                  label: "I agree to receive important updates and notifications via SMS.",
                  helper: "Message frequency may vary. Standard rates may apply.",
                  badge: "Optional",
                  badgeVariant: "optional",
                  checked: smsOptIn,
                  onChange: (v) => setSmsOptIn(v),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "span",
                          {
                            className: `shrink-0 text-[10px] font-medium font-body px-1.5 py-0.5 rounded-full ${item.badgeVariant === "required" ? "bg-destructive/10 text-destructive" : "bg-muted text-muted-foreground"}`,
                            children: item.badge
                          }
                        )
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body mt-1 leading-relaxed", children: item.helper })
                    ] })
                  ]
                },
                item.id
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: submitQuote.isPending ? "Sending…" : "Request a Quote"
              }
            ),
