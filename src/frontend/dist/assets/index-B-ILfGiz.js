const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-D7fh5uSM.js","assets/index-CaSA0imw.js","assets/Properties-BoxvArDj.js","assets/properties-B0tn4lYf.js","assets/PropertyDetail-C9M8hSBB.js"])))=>i.map(i=>d[i]);
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { id: "contact", className: "bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-8 py-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded border-2 border-accent flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-accent text-sm tracking-wider", children: "M" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-semibold text-sm tracking-widest text-accent uppercase", children: "MFG" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary-foreground/60 tracking-wide", children: "Manza Familia Group" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-primary-foreground/65 leading-relaxed max-w-sm mb-8", children: "A leading UK property consultancy dedicated to sourcing exceptional residential and commercial properties for discerning clients. Trusted expertise, curated results." }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xs tracking-widest uppercase text-accent mb-5", children: "Contact Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "mt-0.5 shrink-0 text-accent/70" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+44 (0) 7309 048 018" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 14, className: "mt-0.5 shrink-0 text-accent/70" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "wabasolelejonathan@gmail.com" })
              ]
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3 text-sm text-primary-foreground/65", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "mt-0.5 shrink-0 text-accent/70" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-xs tracking-widest uppercase text-accent mb-5", children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: [
          ...
          "Market Appraisals",
          "Property Sourcing"
        ].map((service) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "li",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-8 border-t border-primary-foreground/10 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-primary-foreground/40", children: [
        "© ",
        year,
        " Manza Familia Group. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-primary-foreground/30", children: [
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-primary text-primary-foreground border-b border-primary/20 sticky top-0 z-50 shadow-lg", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "leading-tight", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display font-semibold text-sm tracking-widest text-accent uppercase", children: "MFG" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-primary-foreground/70 tracking-wide", children: "Manza Familia Group" })
            ] })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "nav",
        {
          ...
          children: navLinks.map(
            (link) => link.to === "/#contact" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                href: link.to,
              ...
              {
                to: link.to,
                className: `text-sm font-body tracking-wide transition-colors duration-200 ${isActive(link.to) ? "text-accent font-medium" : "text-primary-foreground/75 hover:text-accent"}`,
                "data-ocid": `nav.${link.label.toLowerCase()}_link`,
                children: link.label
              },
              link.label
    ...
    mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "max-w-7xl mx-auto px-6 py-4 flex flex-col gap-4", children: navLinks.map(
          (link) => link.to === "/#contact" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
              href: link.to,
            ...
            Link,
            {
              ...
              className: `text-sm font-body tracking-wide transition-colors duration-200 py-1 ${isActive(link.to) ? "text-accent font-medium" : "text-primary-foreground/75 hover:text-accent"}`,
              "data-ocid": `nav.mobile_${link.label.toLowerCase()}_link`,
              children: link.label
            },
            link.label
...
const Home = reactExports.lazy(
  () => __vitePreload(() => import("./Home-D7fh5uSM.js"), true ? __vite__mapDeps([0,1]) : void 0).then((m) => ({ default: m.Home }))
);
const Properties = reactExports.lazy(
  () => __vitePreload(() => import("./Properties-BoxvArDj.js"), true ? __vite__mapDeps([2,3]) : void 0).then((m) => ({ default: m.Properties }))
);
const PropertyDetail = reactExports.lazy(
  () => __vitePreload(() => import("./PropertyDetail-C9M8hSBB.js"), true ? __vite__mapDeps([4,1,3]) : void 0).then((m) => ({ default: m.PropertyDetail }))
);
const PageFallback = () => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 py-16 space-y-4", children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-1/3" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-6 w-2/3" }),
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mt-8", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-72 w-full rounded-lg" }, i)) })
] });
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) })
});
